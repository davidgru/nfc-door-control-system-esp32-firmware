...
namespace DC {
    ...
    class TokenDeleteHandler : public HandlerThatValidatesPSK {

    public:

        /**
         * @brief Construct a new Token Delete Handler object.
         * 
         * @param pskValidator A PSK validator.
         * @param database Database containing valid tokens.
         */
        TokenDeleteHandler(Validator<PSK>& pskValidator, Database& database);
